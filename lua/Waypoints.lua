	...
	if waypoints_available then
		...
		if wp and wp.bitmap and wp.distance and wp.arrow and data.distance then
		    if HMH:GetOption("waypoints") then
			    wp.bitmap:set_color(BeardLib and hotlinemiamihud and hotlinemiamihud.Options:GetValue("WaypointIcon") or Color("66ff99"))
			    wp.distance:set_color(BeardLib and hotlinemiamihud and hotlinemiamihud.Options:GetValue("WaypointDist") or Color("66ffff"))
			    wp.arrow:set_color(BeardLib and hotlinemiamihud and hotlinemiamihud.Options:GetValue("WaypointArrow") or Color("66ffff"))
			end
