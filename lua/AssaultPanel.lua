...
Hooks:PostHook(HUDAssaultCorner, "init", "HMH_hudassaultcorner_init", function(self, hud, ...)
    self._assault_color = BeardLib and hotlinemiamihud.Options:GetValue("AssaultText") or Color("ffcc66")
	self._vip_assault_color = BeardLib and hotlinemiamihud.Options:GetValue("CaptainText") or Color("ff6666")
	...
	if managers.skirmish:is_skirmish() then
		self._assault_color = BeardLib and hotlinemiamihud.Options:GetValue("HoldoutText") or Color("ff6666")
	end
	...
	hostage_text:set_color(BeardLib and hotlinemiamihud.Options:GetValue("HostagesText") or Color("66ffff"))
	hostages_icon:set_color(BeardLib and hotlinemiamihud.Options:GetValue("HostagesIcon") or Color("ff80df"))
	...
	icon_casingbox:set_color(BeardLib and hotlinemiamihud.Options:GetValue("CasingIcon") or Color("ff80df"))
	...
	casing_panel:text({
		name = "text",
        color = BeardLib and hotlinemiamihud.Options:GetValue("CasingText") or Color("66ff99"),
		font = tweak_data.hud.medium_font_noshadow
	})
	...
	icon_noreturnbox:set_color(BeardLib and hotlinemiamihud.Options:GetValue("NoReturnIcon") or Color("ff6666"))
	point_of_no_return_text:set_color(BeardLib and hotlinemiamihud.Options:GetValue("NoReturnText") or Color("66ffff"))
	point_of_no_return_timer:set_color(BeardLib and hotlinemiamihud.Options:GetValue("NoReturnTimer") or Color("ff6666"))
	...
	vip_icon:set_color(BeardLib and hotlinemiamihud.Options:GetValue("CaptainBuffIcon") or Color("ffcc66"))
...
Hooks:PostHook(HUDAssaultCorner, "setup_wave_display", "HMH_hudassaultcorner_setup_wave_display", function(self, top, ...)
	if self:should_display_waves() then
	    ...
	    waves_icon:set_color(BeardLib and hotlinemiamihud.Options:GetValue("WavesIcon") or Color("ff80df"))
	    num_waves:set_color(BeardLib and hotlinemiamihud.Options:GetValue("WavesText") or Color("66ffff"))
	end
end)
