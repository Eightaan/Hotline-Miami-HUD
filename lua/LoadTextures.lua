function HMH:LoadTextures()
	...
	elseif preset_1_2 and HMH:GetOption("interact_texture") == 3 then
		DB:create_entry(Idstring("texture"), Idstring("guis/textures/pd2/hud_progress_active"), HMH._path .. "assets/guis/textures/pd2_mod_hmh/triangle_bg.texture")
		DB:create_entry(Idstring("texture"), Idstring("guis/textures/pd2/hud_progress_invalid"), HMH._path .. "assets/guis/textures/pd2_mod_hmh/triangle_bg.texture")
	...
	elseif preset_1_2 and HMH:GetOption("interact_texture") == 8 then
