if not (HMH:GetOption("PLAYER_down") or HMH:GetOption("TEAM_down")) or VHUDPlus and (VHUDPlus:getSetting({"CustomHUD", "HUDTYPE"}, 2) == 3 or VHUDPlus:getSetting({"CustomHUD", "ENABLED"}, true) and VHUDPlus:getSetting({"CustomHUD", "TEAMMATE", "DOWNCOUNTER"}, true)) or WolfHUD and WolfHUD:getSetting({"CustomHUD", "ENABLED"}, true) or (restoration and restoration:all_enabled("HUD/MainHUD", "HUD/Teammate")) or (CustomEOStandalone and getSetting({"WolfHUDCustomHUD", "ENABLED"}, true)) then return 
end
