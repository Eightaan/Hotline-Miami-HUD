Hooks:PostHook(HUDHeistTimer, "init", "HMMTimer", function(self, hud, tweak_hud)
	...
	self._timer_text:set_color(HMH:GetOption("timer") and HMH:GetColor("TimerColor") or Color.white)
    self._timer_text:set_alpha(HMH:GetOption("timer") and HMH:GetOption("TimerAlpha") or 1)
end)