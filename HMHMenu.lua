...
function HMHMenu:init()
   local aspect_ratio = RenderSettings.resolution.x / RenderSettings.resolution.y
	...
	self:GetMenuFromJson(HMH._menu_path .. "ToggleInteraction/ToggleInteractionOptions.json", HMH._data)
    self:GetMenuFromJson(HMH._menu_path .. "MenuOptions/Main.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "MenuOptions/MainMenu/MainMenuOptions.json", HMH._data)
	...
	self:GetMenuFromJson(HMH._menu_path .. "MenuOptions/Inventory/InventoryOptions.json", HMH._data)
	...
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Interaction/InteractionOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Assault/AssaultOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Tabstats/TabstatsOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Hint/HintOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Waypoint/WaypointOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Chat/ChatOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Timer/TimerOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Presenter/PresenterOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Suspicion/SuspicionOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Carry/CarryOptions.json", HMH._data)
    self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Objectives/ObjectivesOptions.json", HMH._data)
    self:GetMenuFromJson(HMH._menu_path .. "HudOptions/Subtitle/SubtitleOptions.json", HMH._data)
