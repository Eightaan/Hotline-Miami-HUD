...
function HMHMenu:init()
   local aspect_ratio = RenderSettings.resolution.x / RenderSettings.resolution.y
	...
	self:GetMenuFromJson(HMH._menu_path .. "EnhancedLoadout/EnhancedLoadoutOptions.json", HMH._data)
	self:GetMenuFromJson(HMH._menu_path .. "SkipMenus/SkipMenusOptions.json", HMH._data)
